            ...
            <div class="row align-items-center justify-content-between">
                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                ...
                                <li><a href="/fore/foreIndex">校园资讯</a></li>
                                <li><a href="/fore/foreIndex">常问问题</a></li>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <div class="navigation-search d-none d-lg-block">
                        <form method="post" action="/fore/foreIndex">
                            <input type="search" placeholder="" name="pName" id="">
                            <button type="submit"><i class=</button>
                        </form>
                    </div>
